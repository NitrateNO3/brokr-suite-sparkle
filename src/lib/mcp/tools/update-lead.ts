...
export default defineTool({
  name: "update_lead",
  title: "Update lead",
  description: "Update a lead's status, internal notes, assignee or next follow-up date/time.",
  inputSchema: {
    ...
    status: z
      ...
      .trim()
      .optional()
      .describe("new, contacted, qualified, negotiating, won, lost."),
    ...
    mark_contacted: z
      .boolean()
      .optional()
      .describe("Stamp last contacted now and clear the pending follow-up."),
  },
  annotations: {
    readOnlyHint: false,
